...
1. 克隆 =reveal.js= 项目
   #+BEGIN_SRC shell :tangle ~/.emacs.d/no
...
* init-dev.el
:PROPERTIES:
:HEADER-ARGS: :tangle ~/.emacs.d/lisp/init-dev.el :mkdirp yes
:END:
...
* init-mail.el
:PROPERTIES:
:HEADER-ARGS: :tangle ~/.emacs.d/lisp/init-mail.el :mkdirp yes
:END:
